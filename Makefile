...
envoy:
	cd client; docker build -t cs1680-final-project .; docker create --name cs1680-final-project -p 3333:3333 -p 9901:9901 cs1680-final-project; docker start cs1680-final-project; cd ..
